<template>
    ...
    <!-- 제목, 내용 form -->
    <!-- 이름 -->
    <div class="w-full h-full mt-15 flex flex-col gap-5">
        <form>
            <input type="text" id="title" class="bg-gray-300  text-gray-600 p rounded-sm block ps-4 py-2 min-w-[80%] mx-auto"
                placeholder="제목을 입력해주세요" v-model="title" />
            <textarea id="content"
                class="bg-gray-300 text-gray-600 p rounded-sm block min-w-[80%] min-h-[300px] p-2 mt-7 ps-4 pt-2 mx-auto"
